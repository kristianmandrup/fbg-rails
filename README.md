...
In `application.js` manifest (polyfill for media queries):
...
Apple touch icons are available in `/asseets/fbg/icons/` fx 

```haml
= image_tag 'fbg/icons/apple-touch-icon-114x114'
```
